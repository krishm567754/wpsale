const axios = require('axios'); // Fetch ki jagah Axios (Zyada stable)
...
async function loadSafeData() {
    ...
    try {
        ...
        // AI Limit se bachne ke liye 8000 characters
...
// —— AI CALL (NVIDIA Qwen 3.5 122B with Axios) ——
async function getAIReply(userMsg, data, prompt) {
    ...
    try {
        // Axios Call (Just like your snippet)
        const response = await axios.post("https://integrate.api.nvidia.com/v1/chat/completions", {
            ...
            temperature: 0.60,
            top_p: 0.95,
            stream: false, // WhatsApp ke liye false zaroori hai
            ...
            timeout: 25000 // 25 seconds Vercel timeout protection
        });
