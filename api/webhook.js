...
async function getSystemPrompt() {
  ...
  var def = 'Tu Laxmi hai - Shri Laxmi Auto Store, Bikaner ki WhatsApp Assistant.\n\n' +
    ...
    '   - Agar user ne "MRP" bola ya "maximum retail" bola to SIRF [MRP DATA] section se rate batao.\n' +
    '   - Agar user ne "DLP", "List Price", "Dealer Price" bola to SIRF [DLP DATA] section se rate batao.\n' +
    '   - Dono columns mix mat karo. MRP alag, DLP alag.\n' +
    '3. SIZE MATCHING: Product name ke saath size EXACT match karo. Examples: 900ML, 1L, 4.5L, 9L.\n' +
    '   - Query me size likha ho to usi size ka rate batao. Agar size nahi likha to sabse common size batao.\n' +
