...
// ✅ Normalize size headers: "900ml", "0.9l", "900ML" → "900ML"
...
async function loadAllData() {
  ...
  // Load invoice Excel files (exclude price lists)
  ...
  // Format invoice data for AI (unchanged)
...
module.exports = async function(req, res) {
  ...
  try {
    ...
    // ✅ Product Search with Excel Maps (100% Accurate)
