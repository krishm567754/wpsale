...
// Load Excel File (Local from Repo)
function loadLocalSalesData() {
  try {
    ...
    console.log('⚠️ sales.xlsx not found in root!');
    return [];
  } catch (err) { 
...
async function startBot() {
  console.log('🚀 Starting Castrol Sales Bot (Lite Mode)...');
  
  try { await initFirebase(); } catch(e) { console.log("Firebase bypass."); }
  ...
  sock.ev.on('messages.upsert', async ({ messages, type }) => {
    ...
    for (const msg of messages) {
      ...
      try {
        ...
        } catch (e) { console.log("Firebase delay, using default instructions."); }
